...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	// Abaixo, o metodo trata excecoes de violacao de constraints de validacao do Bean Validation
	@Override
	...
	private ResponseEntity<Object> handleValidationInternal(Exception ex, BindingResult bindingResult, HttpHeaders headers, HttpStatus status, WebRequest request) {
		...
		List<Problem.Object> problemObjects = bindingResult.getAllErrors().stream()
				.map(objectError -> {
					// O messageSource abaixo e' responsavel por pegar as mensagens no arquivo "src/main/resources/application.properties"
	...
	// O metodo sobrescrito abaixo e' da classe ResponseEntityExceptionHandler e serve para customizar a resposta de uma 
	// requisicao HTTP que lancou uma excecao
	@Override
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers, HttpStatus status, WebRequest request) {
		// O if abaixo e' para os casos de excecoes que nao foram tratadas acima e nao passamos uma mensagem personalizada
		if (body == null) {
			...
			// O else e' para os casos em que queremos mostrar uma mensagem personalizada no corpo da resposta
			body = Problem.builder()
					.timestamp(LocalDateTime.now())
					.title(status.getReasonPhrase())
					.status(status.value())
	...
	// ABAIXO, METODOS AUXILIARES QUE NAO TRATAM EXCECAO
